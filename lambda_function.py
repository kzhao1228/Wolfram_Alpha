...
def get_welcome_response():
    session_attributes = {}
    card_title = "Welcome to Wolfram Alpha"
...
def get_Wolfram(intent, session):
    ...
    query = query.replace('%20', ' ')
    result = "I'm sorry. " + str(query) + " is not something I know very much about in this skill." 
...
def get_help():
    session_attributes = {}
    card_title = "Help"
    speech_output = "Ask Wolfram Alpha a question."
    should_end_session = False
    reprompt_text = "I must be deaf, what did you say?"
    return build_response(session_attributes, build_speechlet_response(
        card_title, speech_output, reprompt_text, should_end_session))
...
def signoff():
    ...
    speech_output = "Thank you for using Wolfram Alpha, see you soon!"
