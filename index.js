...
const data = [
  ...
  //{electromag: 'which law states that the curl of an electric field is zero?', answer: 'electro static circulation'}, 
  {electromag: 'Is the divergence of the magnetic field always zero?', answer: 'true'}, 
  //{electromag: 'Is the curl of an electric field always zero?', answer: 'true'},
  //{electromag: 'Are there 5 pi steradians in a sphere?', answer: 'false'},
  //{electromag: 'Is the electric field strength inside a capacitor always zero?', answer: 'true'},
  //{electromag: 'Does the Lorentz force act parallel to the direction of motion?', answer: 'false'},
  //{electromag: 'The presence of a dielectric in a capacitor increases the electric field strength', answer: 'false'},
  //{electromag: 'Two parallel current carrying wires exert an attractive force on each other', answer: 'true'},
  //{electromag: 'Two anti-parallel current carrying wires exert an attractive force on each other', answer: 'false'},
  //{electromag: 'Electric field lines start from negative charges and end on positive charges', answer: 'false'},
  //{electromag: 'The electric potential energy at a point is defined as the energy needed to bring a unit charge from infinite distance at constant speed to the point', answer: 'true'},
  //{electromag: 'There are no magnetic monopoles', answer: 'true'},
  //{electromag: 'Faradays law states that the induced emf is proportional to the rate of change of magentic flux', answer: 'true'},
  //{electromag: 'Lenzes law states that the direction of the induced current will be so as to oppose the change that caused it' , answer: 'true'},
  //{electromag: 'The surface of an arbitrariy shaped cavity within a conductor has a non-zero net charge', answer: 'false'},
  //{electromag: 'The electric flux due to a point charge within a closed surface will depend on the shape of that surface', answer: 'false'},
  //{electromag: 'The surface of an arbitrariy shaped cavity within a conductor has a non-zero net charge', answer: 'false'},
  //{electromag: 'In order to find the magnetic flux through a surface, you would have to take the integral B dot d s through the surface', answer: 'true'},
  //{electromag: 'The force due to a magnetic field is a conservative force', answer: 'false'},
  //{electromag: 'which law states that the closed surface integral of E dot d s is the total charged enclosed over epsilon nought?', answer: 'Gauss'},
...
const welcomeMessage = `Welcome to the Physics Education Skill. You can ask me about any physics topic relating to electromagntism, or you can ask me to start a quiz. What would you like me to do?`;
const startQuizMessage = `OK.  I will ask you 10 questions about Electromagnetism. `;
const exitSkillMessage = `Thank you for playing the Physics quiz!`;
const repromptSpeech = `What other part of Electromagnetism would you like to know about?`;
const helpMessage = `I know lots of things about Electromagnetism.  You can ask me about Electromagnitism, and I'll tell you what I know.  You can also test your knowledge by asking me to start a quiz.  What would you like to do?`;
const useCardsFlag = false;
...
function getSpeechDescription(item) {
  return `${item.electromag} states that the ${item.Electromag}.Which other equation or theory would you like to know about?`;
}
...
function getQuestion(counter, property, item) {
  return `Here is your ${counter}th question.  ${item.electromag}`;
}
...
function getQuestionWithoutOrdinal(property, item) {
  return "What is the " + formatCasing(property).toLowerCase() + " of "  + item.electromag;
}

function getAnswer(property, item) {
  switch (property) {
    case 'Abbreviation':
      return `<say-as interpret-as='spell-out'>${item[property]}</say-as>. `;
    default:
      return `It's ${item[property]}. `;
  }
}
...
function compareSlots(slots, value) {
 ...
 let answergiven = this.event.request.intent.slots.answer.value;
 let status = this.event.request.intent.slots.genre.resolutions.resolutionsPerAuthority[0].status.code;
